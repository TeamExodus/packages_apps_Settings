 ...
 */
public class AOSPSecuritySettings extends SettingsPreferenceFragment
    ...
    private static int getResIdForLockUnlockScreen(Context context,
        ...
        if (!lockPatternUtils.isSecure()) {
            ...
            if (singleUser && lockPatternUtils.isLockScreenDisabled()) {
                resid = R.xml.aosp_security_settings_lockscreen;
            } else {
                resid = R.xml.aosp_security_settings_chooser;
            }
        } else if (lockPatternUtils.usingBiometricWeak() &&
                lockPatternUtils.isBiometricWeakInstalled()) {
            resid = R.xml.aosp_security_settings_biometric_weak;
        } else {
            switch (lockPatternUtils.getKeyguardStoredPasswordQuality()) {
                case DevicePolicyManager.PASSWORD_QUALITY_SOMETHING:
                    resid = R.xml.aosp_security_settings_pattern;
                    break;
                case DevicePolicyManager.PASSWORD_QUALITY_NUMERIC:
                case DevicePolicyManager.PASSWORD_QUALITY_NUMERIC_COMPLEX:
                    resid = R.xml.aosp_security_settings_pin;
                    break;
                case DevicePolicyManager.PASSWORD_QUALITY_ALPHABETIC:
                case DevicePolicyManager.PASSWORD_QUALITY_ALPHANUMERIC:
                case DevicePolicyManager.PASSWORD_QUALITY_COMPLEX:
                    resid = R.xml.aosp_security_settings_password;
                    break;
            }
        }
        return resid;
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        if (mIsPrimary) {
            if (LockPatternUtils.isDeviceEncryptionEnabled()) {
                ...
                addPreferencesFromResource(R.xml.aosp_security_settings_encrypted);
            } else {
                // This device supports encryption but isn't encrypted.
                addPreferencesFromResource(R.xml.aosp_security_settings_unencrypted);
            }
        }
        ...
        if (resid == R.xml.aosp_security_settings_biometric_weak &&
        ...
        addPreferencesFromResource(R.xml.aosp_security_settings_misc);
        ...
        Index.getInstance(getActivity())
                .updateFromClassNameResource(AOSPSecuritySettings.class.getName(), true, true);
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        if (KEY_LOCK_AFTER_TIMEOUT.equals(key)) {
            ...
            try {
                ...
                Log.e("AOSPSecuritySettings", "could not persist lockAfter timeout setting", e);
            }
            updateLockAfterPreferenceSummary();
