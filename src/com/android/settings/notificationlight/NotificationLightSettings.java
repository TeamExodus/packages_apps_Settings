...
import com.android.settings.exodus.PackageListAdapter;
import com.android.settings.exodus.PackageListAdapter.PackageItem;
import com.android.settings.exodus.SystemSettingSwitchPreference;
...
public class NotificationLightSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        mMenu = menu;
        mMenu.add(0, MENU_ADD, 0, R.string.notification_add)
    ...
    public Dialog onCreateDialog(int id) {
        ...
        switch (id) {
            case DIALOG_APPS:
                ...
                builder.setTitle(R.string.notification_choose_app);
